...
exports.signin = async (req, res) => {
    try {
        ...
        const accesToken = jwt.sign({ token: result._id }, process.env.JWT_SECRET, { expiresIn: "30d" });
        if (!accesToken) {
...
exports.login = async (req, res) => {
    try {
        ...
        return res.status(400).json({ msg: "Error in login!", err: err.message });
    }
}
...
exports.userDetails = async (req, res) => {
    try {
        ...
        const user = await User.findById(id)
            ...
            .populate({ path: "reposts", populate: [{ path: "likes" },
                { path: "comments" }, { path: "admin" }] });
        res.status(200).json({ msg: "User details fetched!", user });
    }
    catch (err) {
        return res.status(400).json({ msg: "Error in getting user details!", err: err.message });
    }
}
...
exports.followUser = async (req, res) => {
    try {
        ...
        return res.status(400).json({ msg: "Error in following user!", err: err.message });
    }
}
...
exports.updateProfile = async (req, res) => {
    try {
        ...
        return res.status(400).json({ msg: "Error in updating profile!", err: err.message });
    }
}
...
exports.searchUser = async (req, res) => {
    try {
        ...
        return res.status(400).json({ msg: "Error in searchUser!", err: err.message });
    }
}
...
exports.logout = async (req, res) => { 
    try {
        ...
        return res.status(400).json({ msg: "Error in log out!", err: err.message });
    }
}
...
exports.myInfo = async (req, res) => {
    ...
    try {
        ...
        return res.status(400).json({ msg: "Error in myInfo!" });
    }
}

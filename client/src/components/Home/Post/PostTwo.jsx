        ...
        >
            <Stack flexDirection={'column'} gap={2}>
                <Stack flexDirection={'column'}>
                    ...
                    >
                        Hi guys, review my project give your feedback in comments!
                    </Typography>
                    </Link>
                </Stack>
                <img 
                ...
                <Stack flexDirection={'column'} gap={1}>
                    ...
                    left={4}
                    >
                        <Typography variant="caption" fontSize={_700 ? '1.1rem' : '1rem'} color={darkMode?"white":"GrayText"}>2 Like .</Typography>
                        <Typography variant="caption" fontSize={_700 ? '1.1rem' : '1rem'} color={darkMode?"white":"GrayText"}>1 comment</Typography>
                    </Stack>
                </Stack>
            </Stack>
        </Stack>
